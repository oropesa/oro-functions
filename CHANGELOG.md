...
- Update libs:
  - `fs-extra` from `v11.3.2` to `v11.3.4`.
  - `oro-functions-client` from `v2.3.6` to `v2.3.7`.
  - `zip-lib` from `v1.1.2` to `v1.2.2`.
- Update _dev_ libs:
...
- Improve `processWrite` _fn_:
  - Add attributes `bold`, `crossedout`, `italic`, `underline`, `underlinedouble`.
  - Update colors: [`black`, `blueflat`, `blue`, `cyanflat`, `cyan`, `gray`, `grayflat`, `graylight`, `green`, `greenflat`, `red`, `redflat`, `purple`, `purpleflat`, `yellow`, `yellowflat`].
  - Update backgrounds: [`black`, `blueflat`, `blue`, `cyanflat`, `cyan`, `gray`, `grayflat`, `graylight`, `green`, `greenflat`, `inverse`, `red`, `redflat`, `purple`, `purpleflat`, `yellow`, `yellowflat`].
  - Deprecate `white`, `redlight`, `bluelight`. Use `yellow`, `purple` ,`cyan` instead.
